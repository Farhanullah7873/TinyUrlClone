    ...
    <div className="bg-gradient-to-b     flex flex-colum from-[rgb(2,61,92)] via-[rgb(26,97,135)] to-[rgb(66,167,222)]  gap-5 flex-wrap z-0   bg-[rgb(72,191,255)] h-full  pt-19 bg-fixed">
      <div className="form ">
        <form className=" bg-white w-100 h-80 ms-4 p-4 mt-9 rounded-2xl">
          ...
          <button class="bg-green-500 hover:bg-green-700 text-white font-bold mt-5 w-80  ms-3 py-2 px-4 rounded">
            Button
          </button>
        </form>
      </div>
      <div className="description w-200 mt-8 text-white h-130 p-4">
        ...
        <div className="flex mt-4 gap-5">
          <button onClick={viewPlans} class=" hover:bg-white hover:text-gray-400   text-gray-100 border border-gray-400 font-bold py-2 px-7 rounded">
            View Plans
          </button>
          <button onClick={openSignUpDrawer} class="bg-blue-500 bg-white hover:bg-gray-200 text-gray-400 font-bold py-2 px-7 rounded">
            Create Free Account
          </button>
        </div>
        <div className="TinyURLplans mt-4 ">
          ...
          <ul className="mt-3  fle">
            <li className="flex items-center justify-between w-47"><FaChartLine /> <span>Detailed Link Analytics</span></li>
            <li className="flex items-center justify-between w-47 "><FaGlobe /> <span>Fully Branded Domains</span></li>
            <li className="flex items-center justify-between w-35 "><FaLinkSlash /><span>Bulk Short URLs</span></li>
            <li className="flex items-center justify-between w-54 "> <FaSquareShareNodes /><span>Link Management Features</span></li>
          </ul>
        </div>
      </div>
    </div>
