...
function openDrawer() {
                            ...
                            <div className="mt-0  items-center gap-x-2">
                              ...
                              >
                                <FaSignInAlt /> Create An Account
                                 ...
                                 <p className="sm:col-span-3 text-center  ">Already A User ?<button className="text-[#0980a1] cursor-pointer" onClick={() => openDrawer()} >Login</button></p>
                               <p className="sm:col-span-3 text-center ">Already Have An Account ?</p>
                               <ul className="flex sm:col-span-3 justify-center gap-5  ">
                                <li className="bg-[#0980a1] text-white p-4 rounded-[12px]"><FaFacebookF /></li>
                                <li className="bg-[#0980a1] text-white p-4 rounded-[12px]"><FaGoogle /></li>
                                <li className="bg-[#0980a1] text-white p-4 rounded-[12px]"><FaXTwitter /> </li>
                                <li className="bg-[#0980a1] text-white p-4 rounded-[12px]"><FaMicrosoft /></li>
                               </ul>
 ...
 <SigninDrawer open={openSignUp} setOpen={setSignUp} />
    </>
  );
}
